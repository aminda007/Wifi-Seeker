...
public class WifiOpenAdapter extends ArrayAdapter<String> {
    public WifiOpenAdapter(Context context, String[] wifiNames) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        wifiImage.setImageResource(R.drawable.ic_wifi_blue);
        return customView;
